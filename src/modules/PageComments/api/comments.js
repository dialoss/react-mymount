...
// }
//
// export function initComments(initDisqus) {
//     let disqus_comments = document.querySelector(".comments");
//     if (disqus_comments == null) return;
//     initComment(Nav.relativeURL, disqus_comments.classList[1]);
//
//     if (!initDisqus) return;
