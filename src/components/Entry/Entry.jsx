...
import {initContainerHeight} from "./Item/scripts/transform";
...
const Entry = ({entry}) => {
    ...
    useEffect(() => {
        ...
        // initContainerHeight({container:ref.current});
    }, []);
            ...
            <div className={`entry-${entry.id} entry ${listStyle.entry} content__tab-${entry.tab_id}`}>
                {
                    ...
                    <Link className={listStyle.entry__link} to={entry.page_from}></Link>
                }
